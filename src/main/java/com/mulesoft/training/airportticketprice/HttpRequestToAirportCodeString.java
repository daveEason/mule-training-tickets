...
public class HttpRequestToAirportCodeString extends AbstractTransformer
{
    private static final String REQUEST_PARAMETER = "airportCode=";
    
    public HttpRequestToAirportCodeString()
    {
        super();
        this.registerSourceType(DataTypeFactory.STRING);
        this.registerSourceType(DataTypeFactory.BYTE_ARRAY);
        this.registerSourceType(DataTypeFactory.INPUT_STREAM);
        this.setReturnDataType(DataTypeFactory.create(AirportCodeString.class));
    }

    @Override
    public Object doTransform(Object src, String encoding) throws TransformerException
    {
        return new AirportCodeString(extractNameValue(extractRequestQuery(convertRequestToString(src, encoding))));
    }
